...
namespace KR
{
	...
	public class Monetization : KR.ScriptableSingleton<Monetization>
	{
#if UNITY_EDITOR
		[MenuItem("KR/Monetization/Settings")]
		public static void Advetisement()
		{
			KR.Scriptable.CreateAsset<Monetization>("Assets/KR/Monetization/Resources/");
		}
#endif
		...
		public bool showKRLog, showDummyClient;

		#region EDITOR
#if UNITY_EDITOR

		bool isAdmobInstalled { get { return Directory.Exists(getPath("KR/Monetization/Installed/AdMob")); } }
		bool isUnityAdsInstalled { get { return Directory.Exists(getPath("KR/Monetization/Installed/UnityAds")); } }
		bool isUnityIAPInstalled { get { return Directory.Exists(getPath("KR/Monetization/Installed/UnityIAP")); } }
		bool isPlayGamesInstalled { get { return Directory.Exists(getPath("KR/Monetization/Installed/PlayGames")); } }
		...
		public static string[] adMobFolder = { "KR/Monetization/Installed/AdMob", "GoogleMobileAds", "Plugins/Android/GoogleMobileAdsPlugin" };
		public static string[] unityAdsFolder = { "KR/Monetization/Installed/UnityAds" };
		public static string[] unityIAPFolder = { "KR/Monetization/Installed/UnityIAP", "Plugins/UnityChannel", "Plugins/UnityPurchasing" };
		public static string[] playGamesFolder = { "KR/Monetization/Installed/PlayGames", "GooglePlayGames", "Plugins/Android/libs", "Plugins/Android/MainLibProj" };
		...
		public const string defaultInstallPath = "Assets/KR/Monetization/Packages/";
		public const string defaultAdMobPackage = "AdMob.unitypackage", defaultUnityAdsPackage = "UnityAds.unitypackage",
		defaultUnityIAPPackage = "UnityIAP.unitypackage", defaultPlayGamesPackage = "PlayGames.unitypackage";
